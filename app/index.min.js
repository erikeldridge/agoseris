    ...
    */
      ...
      return {
        ...
        d: [{
          ...
          value: function handleRouteChange({
            ...
            this.currentRoute = Object.entries(this.routes).find(entry => entry[1].match(pathname));
          }
        }, {
          kind: "method",
          ...
          kind: "method",
          key: "isListHidden",
          value: function isListHidden() {
            return !(this.currentRoute[0] === 'blogs' && this.isLoggedIn);
          }
        }, {
          kind: "method",
          key: "arePostsHidden",
          value: function arePostsHidden() {
    ...
    class PostsModel extends EventTarget {
      constructor(...args) {
        ...
        _defineProperty$2(this, "_posts", ['post-a', 'post-b']);
      }
    ...
    let PostsView = _decorate$3([customElement('x-posts')], function (_initialize, _LitElement) {
      ...
      return {
        ...
        d: [{
          ...
          key: "render",
          value: function render() {
            return html`<ul>${this.posts.map(blog => html`<li>${blog}</li>`)}</ul>`;
          }
        }]
      };
    }, LitElement);
