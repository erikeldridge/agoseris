    ...
    */
    ...
    let App = _decorate([customElement('x-app')], function (_initialize, _LitElement) {
      ...
      return {
        ...
        d: [{
          ...
          value() {
            return {
              'default': new routeParser('/agoseris/app/')
            };
          }
          ...
          value: function handleRouteChange({
            ...
            this.currentPath = Object.entries(this.routes).find(entry => entry[1].match(pathname));
          }
        }, {
          kind: "method",
          ...
          value: function isListHidden() {
            return !(this.currentPath[0] === 'default' && this.isLoggedIn);
          }
        }, {
          kind: "method",
          key: "render",
    ...
    class BlogsModel extends EventTarget {
      constructor(...args) {
        ...
        _defineProperty$1(this, "_blogs", ['a', 'b']);
      }
    ...
    let BlogsView = _decorate$2([customElement('x-blogs')], function (_initialize, _LitElement) {
      ...
      return {
        ...
        d: [{
          ...
          key: "render",
          value: function render() {
            return html`<ul>${this.blogs.map(blog => html`<li>${blog}</li>`)}</ul>`;
          }
        }]
      };
    }, LitElement);
