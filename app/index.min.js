(function () {
    ...
    */
    ...
    let ListView = _decorate([customElement('x-list')], function (_initialize, _LitElement) {
    ...
    let AuthView = _decorate([customElement('x-auth')], function (_initialize2, _LitElement2) {
      class AuthView extends _LitElement2 {
        constructor(...args) {
          super(...args);
      ...
      return {
        ...
        d: [{
          ...
          value: function render() {
            return html`
    <button @click="${this.handleClick}">${this.isLoggedIn ? 'logout' : 'login'}</button>
    `;
          }
        }]
      };
    ...
    let App = _decorate([customElement('x-app')], function (_initialize3, _LitElement3) {
      class App extends _LitElement3 {
        constructor(...args) {
          super(...args);
      ...
      return {
        ...
        d: [{
          ...
          kind: "method",
          key: "firstUpdated",
          value: // Maps browser location to app state, so location changes trigger render.
