(function () {
    ...
    */
      ...
      return {
        ...
        d: [{
          ...
          value: function connectedCallback() {
            _get(_getPrototypeOf(App.prototype), "connectedCallback", this).call(this);
    ...
    let AuthView = _decorate$1([customElement('x-auth')], function (_initialize, _LitElement) {
      class AuthView extends _LitElement {
        constructor(...args) {
          super(...args);
    ...
    let PostsView = _decorate$3([customElement('x-posts')], function (_initialize, _LitElement) {
      ...
      return {
        ...
        d: [{
          ...
          key: "render",
          value: function render() {
            return html`<ul>${this.posts.map((post, id) => html`<li><a href="./${this.blog}/${id}">${post}</a></li>`)}</ul>`;
          }
        }]
      };
    }, LitElement);
